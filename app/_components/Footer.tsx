...
export default function Footer() {
  return (
    <section className="relative overflow-hidden bg-background border-t py-8">
        ...
        <div className="-m-8 flex flex-wrap items-center justify-between">
            ...
            <Link href="/">
              <div className="inline-flex items-center">
                <Image
                  ...
                  width={400}
                  height={400}
                  className="size-fit max-w-[150px] object-contain"
                />
              </div>
            </Link>
          </div>
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center">
              <li className="p-5">
                <Link className="font-medium text-gray-600 hover:text-gray-700 hover:underline active:underline" href="/services">
                  Services
                </Link>
              </li>
              <li className="p-5">
                <Link className="font-medium text-gray-600 hover:text-gray-700 hover:underline active:underline" href="/portfolio">
                  Portfolio
                </Link>
              </li>
              <li className="p-5">
                <Link className="font-medium text-gray-600 hover:text-gray-700 hover:underline active:underline" href="/contact">
                  Contact Us
                </Link>
              </li>
            </ul>
